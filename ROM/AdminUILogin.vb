...
Public Class AdminUILogin
    ...
    Private Sub LogIn_Click(sender As Object, e As EventArgs) Handles LogIn.Click
        ...
        Try
            If (DBConn.Connection.State = ConnectionState.Open) Then
                Dim cmd As New MySqlCommand("SELECT * FROM admin WHERE username=@username AND password=@password", DBConn.Connection)
    ...
    Private Sub AdminUILogin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ErrorDisplay.Text = ""
    End Sub

    Private Sub AdminUILogin_Close(sender As Object, e As EventArgs) Handles MyBase.Closed
        If IsLoggedIn Then
            Return
        End If
